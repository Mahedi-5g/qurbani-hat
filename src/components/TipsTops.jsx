    ...
    return (
        <div className="mx-7 ">
            ...
            <div className="w-full flex justify-end pt-5">
                <div className="hero bg-base-200 w-3/4 rounded-2xl">
                    <div className="hero-content flex-col lg:flex-row gap-10">
                        <Image src="/tips1.png" alt="tips" width={300} height={200} className="rounded-md h-52" />
                        <div>
                            <h1 className="text-5xl font-bold">Goat Qurbani Guide</h1>
            ...
            <div className="w-full flex justify-start py-5">
                <div className="hero bg-base-200 w-3/4 rounded-2xl">
                    <div className="hero-content flex-col lg:flex-row-reverse gap-10">
                        ...
                        <div>
                            <h1 className="text-5xl font-bold">Cow Qurbani Guide</h1>
            ...
            <div className="w-full flex justify-end">
                <div className="hero bg-base-200 w-3/4 rounded-2xl">
                    <div className="hero-content flex-col lg:flex-row gap-10">
                        ...
                        <div>
                            <h1 className="text-5xl font-bold">Sheep Qurbani Guide</h1>
